...
dataPath_result_bayes = './results/bayesChangePt/realKnownCause/bayesChangePt_data_compare_1.csv'
dataPath_result_relativeE = './results/relativeEntropy/realKnownCause/relativeEntropy_data_compare_1.csv'
dataPath_result_numenta = './results/numenta/realKnownCause/numenta_data_compare_1.csv'
dataPath_result_knncad = './results/knncad/realKnownCause/knncad_data_compare_1.csv'
dataPath_result_WindowGaussian = './results/windowedGaussian/realKnownCause/windowedGaussian_data_compare_1.csv'
dataPath_result_contextOSE = './results/contextOSE/realKnownCause/contextOSE_data_compare_1.csv'
dataPath_result_skyline = './results/skyline/realKnownCause/skyline_data_compare_1.csv'
dataPath_result_ODIN = './results/ODIN_result.csv'
# dataPath_result = './results/skyline/realKnownCause/skyline_data_compare_1.csv'
dataPath_raw = './data/realKnownCause/data_compare_1.csv'
...
result_dta.anomaly_score = 0.3 * result_dta_numenta.anomaly_score + 0.5 * breakpoint_candidates + 0.2 * result_dta_bayes.anomaly_score  # breakpoint_candidates # + 0.5 *
...
for normal_point in normal_index:
    nomaly_neighboor = np.array(cmfunc.find_inverneghboor_of_point(tree, X, normal_point), dtype=np.int32)
