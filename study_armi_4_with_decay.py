...
dataPath_result_bayes = './results/bayesChangePt/realKnownCause/bayesChangePt_data_1B3B8D.csv'
dataPath_result_relativeE = './results/relativeEntropy/realKnownCause/relativeEntropy_data_1B3B8D.csv'
dataPath_result_numenta = './results/numenta/realKnownCause/numenta_data_1B3B8D.csv'
dataPath_result_knncad = './results/knncad/realKnownCause/knncad_data_1B3B8D.csv'
dataPath_result_WindowGaussian = './results/windowedGaussian/realKnownCause/windowedGaussian_data_1B3B8D.csv'
dataPath_result_contextOSE = './results/contextOSE/realKnownCause/contextOSE_data_1B3B8D.csv'
dataPath_result_skyline = './results/skyline/realKnownCause/skyline_data_1B3B8D.csv'
dataPath_result_ODIN = './results/ODIN_result.csv'
# dataPath_result = './results/skyline/realKnownCause/skyline_data_1B3B8D.csv'
dataPath_raw = './data/realKnownCause/data_1B3B8D.csv'
...
result_dta.anomaly_score = 0.5 * result_dta_numenta.anomaly_score + 0.0 * breakpoint_candidates + 0.5 * result_dta_bayes.anomaly_score  # breakpoint_candidates # + 0.5 *
...
for anomaly_point in anomaly_index:
    anomaly_neighboor = np.array(cmfunc.find_inverneghboor_of_point(tree, X, anomaly_point,limit_size), dtype=np.int32)
...
for normal_point in normal_index:
    anomaly_neighboor = np.array(cmfunc.find_inverneghboor_of_point(tree, X, normal_point, limit_size), dtype=np.int32)
    for NN_pair in anomaly_neighboor:
...
cmfunc.plot_data('Final Result',
                 ...
                 ('Raw Data', 'Bayes Result', 'EDGE Result', 'Relative Entropy Result', 'Skyline Gaussian Result',
...
cmfunc.plot_data('Zoomed Final Result',
                 [raw_dta.value[720:800], result_dta_bayes.anomaly_score[720:800], breakpoint_candidates[720:800],
